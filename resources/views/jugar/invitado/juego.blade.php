...
<body>
    ...
    <script>
        ...
        function iniciarJuego() {
            ...
            preg = reactivos[id].contenido;
            d1 = reactivos[id].distractor_1;
            d2 = reactivos[id].distractor_2;
            d3 = reactivos[id].distractor_3;
            res = reactivos[id].respuesta_correcta;
            ...
            // Crear un arreglo con las opciones y mezclarlo
            const opciones = [{
                    texto: res,
                    esCorrecta: true
                },
