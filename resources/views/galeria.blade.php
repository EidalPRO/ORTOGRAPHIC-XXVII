        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                    <img src="{{ asset('assets/img/portfolio/FB_IMG_1740633339943.webp') }}" class="img-fluid" alt="">
                    <div class="portfolio-info">
                        <h4>Presentación</h4>
                        <p>Visitamos la secundaria técnica #223 para hablar de programación y mostrar Ortographic.</p>
                        <a href="{{ asset('assets/img/portfolio/FB_IMG_1740633339943.webp') }}" title="Presentación" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                    <img src="{{ asset('assets/img/portfolio/imagen7.webp') }}" class="img-fluid" alt="">
                    <div class="portfolio-info">
                        <h4>Presentación</h4>
                        <p>Visitamos la secundaria técnica #223 para hablar de programación y mostrar Ortographic.</p>
                        <a href="{{ asset('assets/img/portfolio/imagen7.webp') }}" title="Presentación" data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                </div><!-- End Portfolio Item -->
